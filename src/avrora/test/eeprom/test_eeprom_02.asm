; @Target: avr-sim
; @Purpose: "Test reading to and writing from the EEPROM"
; @Result: "r16 = 42, r17 = 42"

; this test case test writing to a high address on the EEPROM and reading back
...
MAIN:
	...
	ldi r20, SUCCESS
	out EEDR, r20
	ldi r18, 0x0f		; init to value within range
	out EEARH, r18
