; @Target: avr-sim
; @Purpose: "Tests that the 4 cycle timeout associated with writes works"
; @Result: "r16 = 42, r17 = 42"

;  This tests that the timeout associated with writes is functional
...
MAIN:
	...
	ldi r18, 0b00000100	; flag EEMWE, start write count
	ldi r20, 0b00000010 ; flag EEWE, initiate a write
	;; the write should not happen, as it missed its opportunity
	out EECR, r18
	nop
	nop
	nop
