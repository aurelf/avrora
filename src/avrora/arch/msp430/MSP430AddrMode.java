...
/**
 * The <code>MSP430AddrMode</code> class represents an addressing mode for this architecture. An addressing mode fixes
 * the number and type of operands, the syntax, and the encoding format of the instruction.
 */
