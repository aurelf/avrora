...
/**
 * The <code>MSP430InstrVisitor</code> interface allows user code that implements the interface to easily dispatch on
 * the type of an instruction without casting using the visitor pattern.
 */
