...
/**
 * The <code>MSP430Instr</code> class is a container (almost a namespace) for all of the instructions in this
 * architecture. Each inner class represents an instruction in the architecture and also extends the outer class.
 */
public abstract class MSP430Instr implements AbstractInstr {
    ...
    /**
     * The default constructor for the <code>MSP430Instr</code> class accepts a string name and a size for each
     * instruction.
     *
