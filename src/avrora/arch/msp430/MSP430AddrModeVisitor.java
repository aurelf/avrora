...
/**
 * The <code>MSP430AddrModeVisitor</code> interface implements the visitor pattern for addressing modes.
 */
public interface MSP430AddrModeVisitor {
    ...
    public void visit_REGSYM(MSP430Instr i, MSP430Operand.SREG source, MSP430Operand.SYM dest);
    ...
    public void visit_SYM(MSP430Instr i, MSP430Operand.SYM source);

    public void visit_SYMREG(MSP430Instr i, MSP430Operand.SYM source, MSP430Operand.SREG dest);

    public void visit_INDSYM(MSP430Instr i, MSP430Operand.INDX source, MSP430Operand.SYM dest);

    public void visit_INDABS(MSP430Instr i, MSP430Operand.INDX source, MSP430Operand.ABSO dest);

    public void visit_SYMABS(MSP430Instr i, MSP430Operand.SYM source, MSP430Operand.ABSO dest);

    public void visit_SYMIND(MSP430Instr i, MSP430Operand.SYM source, MSP430Operand.INDX dest);

    public void visit_SYMSYM(MSP430Instr i, MSP430Operand.SYM source, MSP430Operand.SYM dest);

    public void visit_ABSSYM(MSP430Instr i, MSP430Operand.ABSO source, MSP430Operand.SYM dest);
    ...
    public void visit_IREGSYM(MSP430Instr i, MSP430Operand.IREG source, MSP430Operand.SYM dest);
    ...
    public void visit_IMMSYM(MSP430Instr i, MSP430Operand.IMM source, MSP430Operand.SYM dest);
    ...
    public void visit_AUTOSYM_B(MSP430Instr i, MSP430Operand.AIREG_B source, MSP430Operand.SYM dest);
