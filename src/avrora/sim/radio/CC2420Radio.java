...
import avrora.sim.radio.CC2420Radio.ATMegaController.Transmit;
...
public class CC2420Radio implements Radio  {
    ...
    public CC2420Radio(Microcontroller mcu, int xfreq) {
        ...
        MDMCTRL0_reg = new Modem0Register();
        registers[MDMCTRL0] = MDMCTRL0_reg;
        MDMCTRL1_reg = new Modem1Register();
        registers[MDMCTRL1] = MDMCTRL1_reg;
        RSSI_reg = new RSSIRegister();
        registers[RSSI] = RSSI_reg;
        SYNC_reg = new SyncRegister();
        registers[SYNCWORD]  = SYNC_reg;
        TXCTRL_reg = new TxCtrlRegister();
        registers[TXCTRL] = TXCTRL_reg;
        RXCTRL0_reg = new RxCtrl0Register();
        registers[RXCTRL0] = RXCTRL0_reg;
        RXCTRL1_reg = new RxCtrl1Register();
        registers[RXCTRL1] = RXCTRL1_reg;
        FSCTRL_reg = new FreqSynthRegister();
        registers[FSCTRL] = FSCTRL_reg;
        FSCTRL_reg.setFreq(xfreq);
        IOCFG0_reg = new IORegister0();
        registers[IOCFG0] = IOCFG0_reg;
        IOCFG1_reg = new IORegister1();
        registers[IOCFG1] = IOCFG1_reg;
        TXFIFO_reg = new TXFIFORegister();
        registers[TXFIFO] = TXFIFO_reg;
        RXFIFO_reg = new RXFIFORegister();
        registers[RXFIFO] = RXFIFO_reg;
        TXFIFOBuf = new TXFIFOBuffer();
        RXFIFOBuf = new RXFIFOBuffer();
        SNOP_cmd = new SnopCommand();
        registers[SNOP] = SNOP_cmd;
        SXOSCON_cmd = new SxosconCommand();
        registers[SXOSCON] = SXOSCON_cmd;
        STXCAL_cmd = new StxcalCommand();
        registers[STXCAL] = STXCAL_cmd;
        SRXON_cmd = new SrxonCommand();
        registers[SRXON] = SRXON_cmd;
        STXON_cmd = new StxonCommand();
        registers[STXON] = STXON_cmd;
        STXONCCA_cmd = new StxonccaCommand();
        registers[STXONCCA] = STXONCCA_cmd;
        SRFOFF_cmd = new SrfoffCommand();
        registers[SRFOFF] = SRFOFF_cmd;
        SXOSCOFF_cmd = new SxoscoffCommand();
        registers[SXOSCOFF] = SXOSCOFF_cmd;
        SFLUSHRX_cmd = new SflushrxCommand();
        registers[SLFUSHRX] = SFLUSHRX_cmd;
        SFLUSHTX_cmd = new SflushtxCommand();
        registers[SFLUSHTX] = SFLUSHTX_cmd;
        SACK_cmd = new SackCommand();
        registers[SACK] = SACK_cmd;
        SACKPEND_cmd = new SackpendCommand();
        registers[SACKPEND] = SACKPEND_cmd;
        SRXDEC_cmd = new SrxdecCommand();
        registers[SRXDEC] = SRXDEC_cmd;
        STXENC_cmd = new StxencCommand();
        registers[STXENC] = STXENC_cmd;
        SAES_cmd = new SaesCommand();
        registers[SAES]  = SAES_cmd;
    ...
    protected abstract class RadioRegister {
        ...
        protected byte read() {return Arithmetic.high(value);}  //for FIFO
    ...
    protected class MainRegister extends RadioRegister {
        ...
        protected void printStatus() {
            radioPrinter.println("CC2420[MAIN]: " + resetn + ", encryption module: " + encresetn + ", demodulator module: "
                    + demodresetn + ", modulator module: " + modresetn + ", freq. synthesizer module: "
                    + fsresetn + ", crystal oscillator bypass: " + xosc16m);
        }
    }
    ...
    protected class Modem1Register extends RadioRegister {
        ...
        protected void reset() {
            write((int) 0x0000);   //should be at least 0x0500 before operation though
        }
        protected void decode(int val) {
    ...
    protected class TxCtrlRegister extends RadioRegister {
        ...
        boolean reserved;
        TxCtrlRegister() {
            super("Transmit Control Register", (int)0xa0ff);
            decode(value);
        }
        protected void decode (int val) {
    ...
    protected class RxCtrl0Register extends RadioRegister {
        ...
        int low_lna_cur   = 1;
        RxCtrl0Register() {
            super("RX Control Register 0", (int)0x12e5);
            decode(value);
        }
        protected void decode (int val) {
    ...
    protected class RxCtrl1Register extends RadioRegister {
        ...
        RxCtrl1Register() {
            super("RX Control Register 1", (int) 0x0a56);
            decode(value);
        }
        protected void decode (int val) {
    ...
    protected class FreqSynthRegister extends RadioRegister {
        ...
        int freq;
        FreqSynthRegister() {
            super ("Frequency Synthesizer Control and Status", (int) 0x4165);
            decode(value);
        }
        protected void decode (int val) {
    ...
    protected class IORegister0 extends RadioRegister {
        ...
        IORegister0() {
            super ("I/O Config Register 0", (int) 0x0040);
            decode(value);
        }
        protected void decode (int val) {
    ...
    protected class IORegister1 extends RadioRegister {
        ...
        int ccamux = 0;
        IORegister1() {
            super ("I/O Config Register 1", (int) 0x0000);
            decode(value);
        }
        protected void decode (int val) {
    ...
    protected class StxonccaCommand extends RadioStrobe {
        ...
        protected void action() {
            // if(controller.getPinValueCCA()) {    MOVE getPiNValue and all that junk out of SerialConfigInterface
            if(true) {   //just temp, doesn't mean anything
                switched = true;
    ...
    public class ATMegaController implements Radio.RadioController,
        ...
        public long transmitFrameStart(long startTime, long originalTime) {
            ...
            new TransmitLater(new Transmission((byte)(SFD ),0, startTime),(int)((startTime - originalTime)/ Radio.TRANSFER_TIME));
            startTime +=( Radio.TRANSFER_TIME );
        ...
        public class StartReceiving implements Simulator.Event {
            ...
            public void start(){
                ...
                else sim.insertEvent(this,Radio.TRANSFER_TIME );
            }
            public void end(){
                if(cont instanceof ContinueReceiving)
                cont.end();
                sim.removeEvent(this);
            }
            public void fire(){
        ...
        public void receiveFrame(SPI.Frame frame) {
            ...
            if (regAdd < 0) {
                ...
                if (!transmitting && (STXON_cmd.switched || STXONCCA_cmd.switched)) {
                    //sim.delay(Radio.TRANSFER_TIME - (sim.getClock().getCount() % Radio.TRANSFER_TIME));
                    if(receiving){
                        receivingBytes.end();
                    }
            ...
            if (!controller.getPinValue("CS") && !CSnOld && bytesToCome == 0) { //a transfer of bytes still going, keep same regAdd
                bytesToCome = 2;
            }
        }
        public void ramAccess(SPI.Frame frame) {
            boolean TXBank = (!(Arithmetic.getBit(6,ramBank) && (Arithmetic.getBit(7,ramBank))));  //if bit 6 and 7 not set
            boolean RXBank = ((Arithmetic.getBit(6,ramBank)) && !Arithmetic.getBit(7,ramBank));
            boolean secBank= (!(Arithmetic.getBit(6,ramBank)) && Arithmetic.getBit(7,ramBank));
            ...
            if(bytesToCome == 2){
                ...
                if (TXBank){
                    if(Arithmetic.getBit(5,ramBank)){  //then just read RAM
                        new RAMread(TXFIFOBuf.readRAM((byte)(regAdd & 0x3F)));
                        bytesToCome++; //will keep reading unless CS goes down
                        regAdd++; //add 1 to address for next time
                    }
                    else{ //read and write
                        new RAMread(TXFIFOBuf.readRAM((byte)(regAdd & 0x3f)));
                        TXFIFOBuf.writeRAM((byte)(regAdd & 0x3F),frame.data);
                        bytesToCome++;
                        regAdd++;
                    }
                }
                    ...
                    if(Arithmetic.getBit(5,ramBank)){  //then just read RAM
                        new RAMread(RXFIFOBuf.readRAM((byte)(regAdd & 0x3f)));
                        bytesToCome++;
                        regAdd++;
                    }
                    else{ //read and write
                        new RAMread(RXFIFOBuf.readRAM((byte)(regAdd & 0x3f)));
                        RXFIFOBuf.writeRAM((byte)(regAdd & 0x3F),frame.data);
                        bytesToCome++;
                        regAdd++;
                    }
                }
        ...
        private class ReadReg implements Simulator.Event {
            ...
            public void firing(){
                if (regAdd == TXFIFO || regAdd == RXFIFO){ //the low byte will hold FIFO data
                    ...
                    spiDevice.receiveFrame(SPI.newFrame(Arithmetic.high(registers[regAdd & 0x3F].value)));
                    sim.insertEvent(this,4);
            ...
            public void fire() {
                //means low byte
                spiDevice.receiveFrame(SPI.newFrame(Arithmetic.low(registers[regAdd & 0x3F].value)));
    ...
    public class PinInterface {
        ...
        protected class SCLKOutput implements Microcontroller.Pin.Output {
            public boolean read() {
                print("CC2420: reading SCLK pin value: " + SCLK);
                return SCLK;
            }
            ...
            public void enableOutput() {
                print("CC2420: enabled SCLK pin");
            }
            public void disableOutput() {
                print("CC2420: disabled SCLK pin");
            }
        }
        protected class MISOInput implements Microcontroller.Pin.Input {
            public boolean read() {
                print("CC2420: reading MISO pin value: " + MISO);
                return MISO;
            }
            public void enableInput() {
                print("CC2420: enabled MISO pin");
            }
            public void disableInput() {
                print("CC2420: disabled MISO pin");
            }
        }
        protected class MOSIOutput implements Microcontroller.Pin.Output {
            public byte value;
            int counter;
            MOSIOutput(){
                counter = 0;
            ...
            public boolean read() {
                print("CC2420: reading MOSI pin value: " + MOSI);
                return MOSI;
            }
            public void write(boolean val) {
            ...
            public void enableOutput() {
                print("CC2420: enabled MOSI pin");
            }
            public void disableOutput() {
                print("CC2420: disabled MOSI pin");
            }
        }
        protected class CSOutput implements Microcontroller.Pin.Output {
            public boolean read() {
                print("CC2420: reading CS pin value");
                return readValueCS;
            }
            public void write(boolean val){
            ...
            public void enableOutput() {
                print("CC2420: enabled CS pin ");
            }
            public void disableOutput() {
                print("CC2420: disabled CS pin ");
            }
        }
        public class FIFOInput implements Microcontroller.Pin.Input {
            public boolean read() {
                print("CC2420: reading FIFO pin value");
                return readValueFIFO;
            }
            public void enableInput() {
                print("CC2420: enabled FIFO pin ");
            }
            public void disableInput() {
                print("CC2420: disabled FIFO pin ");
            }
        }
        protected class FIFOPInput implements Microcontroller.Pin.Input {
            public boolean read() {
               print("CC2420: reading FIFOP pin value");
                return readValueFIFOP;
            }
            public void enableInput() {
                print("CC2420: enabled FIFOP pin ");
            }
            public void disableInput() {
                print("CC2420: disabled FIFOP pin ");
            }
        }
        protected class CCAInput implements Microcontroller.Pin.Input {
            public boolean read() {
                print("CC2420: reading CCA pin value");
                return readValueCCA;
            }
            public void enableInput() {
                print("CC2420: enabled CCA pin ");
            }
            public void disableInput() {
                print("CC2420: disabled CCA pin ");
            }
        }
        protected class SFDInput implements Microcontroller.Pin.Input {
            public boolean read() {
                print("CC2420: reading SFD pin value");
                return readValueSFD;
            }
            public void enableInput() {
                print("CC2420: enabled SFD pin ");
            }
            public void disableInput() {
                print("CC2420: disabled SFD pin ");
            }
        }
        public void print(String message){
