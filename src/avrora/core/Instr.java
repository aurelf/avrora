...
//--BEGIN INSTR GENERATOR--
    ...
    public static class CALL extends WORD_class { // call absolute address
        ...
        public CALL(int pc,int a) { super(PADDR(1, a)); }
        public void accept(InstrVisitor v) { v.visit(this); }
    ...
    public static class JMP extends WORD_class { // absolute jump
        ...
        public JMP(int pc,int a) { super(PADDR(1, a)); }
        public void accept(InstrVisitor v) { v.visit(this); }
        public int getSize() { return 4; }
        public int getCycles() { return 3; }
    }
    ...
    public static class LDS extends REGIMM_class { // load direct from SRAM
        ...
        static InstrPrototype prototype = new LDS(0,GPR_default,DADDR_default);
        Instr allocate(int pc,Register a,int b) { return new LDS(pc, a, b); }
        public LDS(int pc,Register a,int b) { super(GPR(1, a),DADDR(2, b)); }
        public void accept(InstrVisitor v) { v.visit(this); }
        public int getSize() { return 4; }
        public int getCycles() { return 2; }
    }
    ...
    public static class STS extends IMMREG_class { // store direct to SRAM
        ...
        static InstrPrototype prototype = new STS(0,DADDR_default,GPR_default);
        Instr allocate(int pc,int a,Register b) { return new STS(pc, a, b); }
        public STS(int pc,int a,Register b) { super(DADDR(1, a),GPR(2, b)); }
        public void accept(InstrVisitor v) { v.visit(this); }
        public int getSize() { return 4; }
        public int getCycles() { return 2; }
    }
